...
(function(){angular.module("jkAngularCarousel.templates", []).run(["$templateCache", function($templateCache) {
  ...
  <div class="jk-carousel" >
   ...
   <!-- <md-radio-group    class="radio-buttons-container"    layout="row"    ng-model="ctrl.radioButtonIndex"    layout-align="center center"    ng-change="ctrl.onRadioButtonClick()" >
      <md-radio-button      ng-repeat="item in ctrl.data"      ng-value="$index"      aria-label="$index" >    </md-radio-button>
   </md-radio-group> -->
   <div layout="row" id="small-carousel">
      ...
      <ul id="small-carousel-images">
         <li ng-repeat="slideItem in ctrl.data"><img ng-click="ctrl.goToSlide($index)" src="{{slideItem.src}}"/></li>
      </ul>
      <md-button class="md-icon-button right-arrow-button" >
         <md-icon ng-click="ctrl.navigateRight()" >chevron_right</md-icon>
      </md-button>
