...
(function() {
  ...
  function CarouselController($timeout, $attrs, $interval, $window) {
    ...
    that.toggleFullScreen = function(){
      ...
      document.getElementById("adfasdf").style.background = 'black';
      ...
      document.getElementById("adfasdf").style.background = 'blue';
      document.getElementById("sabka-baap").style.background = 'blue';
    ...
    that.goToSlide = function(index) {
      ...
      that.applyMarginLeft();
      that.stopAutoSlide();
      console.log("hel gotoslide");

      var childNodes = $("#small-carousel-images").children();
console.log(childNodes);

      for(var i in childNodes)
      {
        if(childNodes[i].id && childNodes[i].id.indexOf('imgScroll') >= 0) $(childNodes[i].id).css({'transition': 'margin 0.5s ease-in-out'});
        // childNodes[i].css('transition', 'margin 0.5s ease-in-out');
      }


      for(var i in childNodes)
      {
        if(childNodes[i].classList) childNodes[i].classList.remove('mini-slider-active');
        if(childNodes[i].id === 'imgScroll'+index){
          childNodes[i].classList.add('mini-slider-active');
          console.log("added");
        }
      }
    };
...
(function() {
  ...
  function CarouselDirective() {
    ...
    function link(scope, element, attrs, ctrl) {
      console.log(attrs);
      if(attrs["miniDisplay"] === "hide"){
        document.getElementById("small-carousel").style.display = 'none';
      }
