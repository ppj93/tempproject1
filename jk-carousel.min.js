...
  return ret;
    ...
    that.updateSlidesContainerHeight = function() {
      ...
      that.currentHeight = that.element.prop('offsetHeight');
      that.resizeSlides();
      var newSlidesContainerHeight = that.currentHeight * that.cloneData.length;
      ...
      $timeout(function() {
        ...
        if(that.slideHorizontally){
          ...
          that.applyMarginLeft();
            ...
            that.currentMarginTopValue = (that.currentHeight * that.data.length) * -1;
            that.applyMarginTop();
        }
